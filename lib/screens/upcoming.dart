            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                matchData.forEach((element) {
                  if (element.data()!["match_status"] == "UpComing") {
                    upcomingMatches.add(element.data()!);
                  }
                });
                return ListView.builder(
                    itemCount: upcomingMatches.length,
                    itemBuilder: (context, index) {
                      Map<String, dynamic> matches = upcomingMatches[index];
                      int len = upcomingMatches.length;
                      print(len);
                      print(matches['match_status']);

                      if (matches['match_status'] == 'UpComing') {
