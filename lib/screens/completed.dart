            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                matchData.forEach((element) {
                  if (element.data()!['match_status'] == 'Completed') {
                    completedMatches.add(element.data()!);
                  }
                });
                return ListView.builder(
                    itemCount: completedMatches.length,
                    itemBuilder: (context, index) {
                      Map<String, dynamic> matches = completedMatches[index];
                      int len = completedMatches.length;
                      print(len);
                      print(matchData[index]['match_status']);

                      if (matches['match_status'] == 'Completed') {
